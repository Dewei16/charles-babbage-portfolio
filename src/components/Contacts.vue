...
<!-- This is from the official documentation of Web3Form -->
<script setup>
...
//The submitForm() handler function sends the form data to web3forms and displays success or failure notification toast
const submitForm = async () => {
  ...
  if (result.success) {
    ...
    isLoading.value = false;
    notyf.error("Faied to send message.")
